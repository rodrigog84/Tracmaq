...
public function cargacontribuyentes(){
	...
	public function exportPDF(){
		...
		/*if($tipodocumento == 1){
				$this->exportFacturaPDF2($idfactura,$numero);
				...
				$this->exportBoletaPDF2($idfactura,$numero);
	...
	public function exportFacturaPDF2($idfactura,$numero){
      ...
      $html .='
		...
		*/
		...
		<table width="987px" height="602" border="0">
		  <tr>
		   <td width="197px"><img src="http://angus.agricultorestalca.cl/vibrados_web/Infosys_web/resources/images/logo_empresa.png" width="150" height="136" /></td>
