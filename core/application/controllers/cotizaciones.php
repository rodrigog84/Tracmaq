...
class Cotizaciones extends CI_Controller {
	...
	public function exportPDF2(){
		...
		<table width="987px" height="602" border="0">
		  <tr>
		   <tr>
		    <td width="150px"><img src="http://angus.agricultorestalca.cl/vibrados_web/Infosys_web/resources/images/logomuni.jpg" width="300" height="200" /></td>
	...
	public function exportPDF(){
		...
		<table width="987px" height="602" border="0">
		  <tr>
		   <tr>
		   <td width="197px"><img src="http://angus.agricultorestalca.cl/Tracmaq/Infosys_web/resources/images/logo.png" width="150" height="136" /></td>
		    <td width="493px" style="font-size: 14px;text-align:center;vertical-align:text-top"	>
		    <p> Empresa TRACMAQ   (SERVICIO TECNICO JUAN CARLOS sANCHEZ EIRL)
		    </p>
		    <p>RUT:</p>
		    <p>Direccion</p>
		    <p>Fonos: </p>
