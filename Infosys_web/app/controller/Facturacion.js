Ext.define('Infosys_web.controller.Facturacion', {
    ...
    refs: [{
       ref: 'panelprincipal',
        ...
        ref: 'productosingresarventas',
        selector: 'productosingresarventas'
    }
    ...
    init: function() {
        ...
        this.control({
           ...
           /* 'facturasprincipal': {
            ...
            'productosingresarventas button[action=grabarproductosventas]': {
                click: this.grabarproductosventas
            }
    ...
    grabarproductosventas: function(){

        var winp    = this.getProductosingresarventas(),
            form   = win.down('form'),
            ...
            params: {
             ...
             success: function(response){
                ...
                var idfactura= resp.idfactura;
                 viewIngresa.close();
                 stFactura.load();
                 window.open(preurl + 'facturas/exportPDF3/?idfactura='+idfactura);
            ...
            success: function(response){
                ...
                if (resp.success == true){                    
                    if(resp.cliente){
                        ...
                        var viewedit = Ext.create('Infosys_web.view.ventas.Ingresar').show();                        
                        viewedit.down("#codigoId").setValue(codigo);
                    }
                    
                }else{

                      var view = Ext.create('Infosys_web.view.ventas.Ingresar').show();
